    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var model = new HomePageModel {
                Events = events.Where(e => e.EventType == Core.EventType.GAME || e.EventType == Core.EventType.EXHIBITION_GAME).Take(4).GroupBy(e => e.StartDate.Date, e => e).OrderBy(k => k.Key),
                News = news
            };
            return View(model);
        }
